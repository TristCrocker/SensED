...
while photo_counter != total_photos:
  ...
  leftName = '/home/raspberry/SensED/images/stereoLeft/imageL'+str(photo_counter)+'.png'
  rightName = '/home/raspberry/SensED/images/stereoLeft/imageL'+str(photo_counter)+'.png'
  if os.path.isfile(leftName) and os.path.isfile(rightName):
      imgLeft = cv2.imread(leftName,1)
      imgRight = cv2.imread(rightName,1)
      cv2.imshow('photo', imgLeft)
      try:
